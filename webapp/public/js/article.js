$(document).ready(function() {
    ...
    $("#btn1").click(function(){
        ...
        $("#xd").append("<div id='"+aa+"' class='row'><input style='display:none'  class='form-control  col-sm-1' id='1' name='article[]' value='"+ idarticulo +"' required />" +
            ...
            "<button id='btn2' style='display:none'  data-id='"+aa+"' class='form-control col-sm-1'>Eliminar</button></div>")
        aa++;
        /*
