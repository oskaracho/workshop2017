...
@section('title', 'Administración de Almacenes')
    ...
    <div class="row">
        <div class="col-lg-12 margin-td">
            ...
            <div class="pull-right">
                <a href="{{route('warehouse.create')}}" class="btn btn-success" style="color:#ffffff">Crear Almacen</a>
            </div>
        </div>
    </div>
                ...
                @foreach($warehouse as $warehouses)
                    ...
                    <tr>
                        ...
                        {{--<a href="{{route('warehouse.show',$warehouses->id)}}" class="btn btn-info">Mostrar</a>--}}
                            <a href="{{route('warehouse.edit',$warehouses->id)}}" class="btn btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i> Editar</a>
                            <a href="" data-target="#modal-delete-{{$warehouses->id}}" data-toggle="modal"><button class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Eliminar</button></a>
                            {{--{!! Form::open(['method'=>'DELETE','route'=>['warehouse.destroy',$warehouses->id],'style'=>'display:inline']) !!}--}}
                        {{--{!! Form::button('<i class="fa fa-trash" aria-hidden="true"></i> Eliminar', array('type' => 'submit','class'=>'btn btn-danger')) !!}--}}
                        {{--{!! Form::close() !!}--}}
                        </td>
                    </tr>
